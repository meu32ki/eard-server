...
class ItemName{
	...
	*/
	private static $listByName = [
		...
		"100μの個人ショップ" => [218,0,4],
		"500μの個人ショップ" => [218,1,4],
		"1000μの個人ショップ" => [218,2,4],
		"2500μの個人ショップ" => [218,3,4],
		"5000μの個人ショップ" => [218,4,4],
		"10000μの個人ショップ" => [218,5,4],
		"25000μの個人ショップ" => [218,6,4],
		"50000μの個人ショップ" => [218,7,4],
		"100000μの個人ショップ" => [218,8,4],
		"水色のシュルカー ボックス" => [218,9,4],
		"紫のシュルカー ボックス" => [218,10,4],
		"青のシュルカー ボックス" => [218,11,4],
		"茶色のシュルカー ボックス" => [218,12,4],
		"緑のシュルカー ボックス" => [218,13,4],
		"赤のシュルカー ボックス" => [218,14,4],
		"黒のシュルカー ボックス" => [218,15,4],
		"紫の彩釉テラコッタ" => [219,0,2],
		"白の彩釉テラコッタ" => [220,0,2],
		...
		"暗視のポーション[延長]" => [373,6,9],
		"透明化のポーション" => [373,7,9],
		"透明化のポーション[延長]" => [373,8,9],
		"跳躍のポーション" => [373,9,9],
		"跳躍のポーション[延長]" => [373,10,9],
		"跳躍Ⅱのポーション" => [373,11,9],
		"耐火のポーション" => [373,12,9],
		"耐火のポーション[延長]" => [373,13,9],
		"スピードのポーション" => [373,14,9],
		"スピードのポーション[延長]" => [373,15,9],
		"スピードⅡのポーション" => [373,16,9],
		"鈍化のポーション" => [373,17,9],
		"鈍化のポーション[延長]" => [373,18,9],
		"水中呼吸のポーション" => [373,19,9],
		"水中呼吸のポーション[延長]" => [373,20,9],
		"回復のポーション" => [373,21,9],
		"回復Ⅱのポーション" => [373,22,9],
		"ダメージのポーション" => [373,23,9],
		"ダメージⅡのポーション" => [373,24,9],
		"毒のポーション" => [373,25,9],
		"毒のポーション[延長]" => [373,26,9],
		"毒Ⅱのポーション" => [373,27,9],
		"再生のポーション" => [373,28,9],
		"再生のポーション[延長]" => [373,29,9],
		"再生Ⅱのポーション" => [373,30,9],
		"力のポーション" => [373,31,9],
		"力のポーション[延長]" => [373,32,9],
		"力Ⅱのポーション" => [373,33,9],
		"弱体化ポーション" => [373,34,9],
		"弱体化ポーション[延長]" => [373,35,9],
		"衰弱のポーション" => [373,36,9],
		"ガラスビン" => [374,0,8],
		"クモの目" => [375,0,9],
		"発酵したクモの目" => [376,0,7],
		...
		"音楽ディスク(13)" => [500,0,0],
		"音楽ディスク(cat)" => [501,0,0],
		"音楽ディスク(blocks)" => [502,0,0],
		"音楽ディスク(chirp)" => [503,0,0],
		"音楽ディスク(far)" => [504,0,0],
		"音楽ディスク(mall)" => [505,0,0],
		"音楽ディスク(mellohi)" => [506,0,0],
		"音楽ディスク(stal)" => [507,0,0],
		"音楽ディスク(strad)" => [508,0,0],
		"音楽ディスク(ward)" => [509,0,0],
		"音楽ディスク(11)" => [510,0,0],
		"音楽ディスク(wait)" => [511,0,0],		
	];
